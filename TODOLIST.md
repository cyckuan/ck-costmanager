...
## COMPLETED
- [x] Plugin scaffold (plugin.json, hooks, command, script)
- [x] Token usage logging via Stop hook
- [x] Per-project tracking via git remote identification
- [x] Cost calculation from modelcost.json rates
- [x] Budget tracking with variance reporting
- [x] Cumulative chart with budget line (terminal-width responsive, 8 rows)
- [x] ANSI colour output
- [x] Logs stored in ~/.claude/cost-logs/ (survives reinstalls)
